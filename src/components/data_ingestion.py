...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            train_set = df[df["Customer_ID"].isin(train_ids)].copy()
            test_set = df[df["Customer_ID"].isin(test_ids)].copy()

            train_set.drop(columns=["Customer_ID"], inplace=True)
            test_set.drop(columns=["Customer_ID"], inplace=True)
